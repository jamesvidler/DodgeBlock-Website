  ...
  <div>
    <Divider speed={0.2} offset={offset} factor={factor}>
      <UpDown>
        ...
        <SVG icon="cube" width={48} color="" left="60%" top="80%" />
        <SVG icon="cube" width={48} color="icon_darkest" left="60%" top="68%" />
        <SVG icon="cube" width={48} color="icon_darkest" left="66.66%" top="86%" />
